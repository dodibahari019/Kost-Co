...
class SewaKamarController extends Controller
{
    ...
    public function getViewSewaKamar()
    {
        ...
        ->leftJoin('penghuni', 'penghuni.id_user', '=', 'pembayaran.id_penghuni')
        ->leftJoin('datausers as data_penghuni', 'data_penghuni.id_user', '=', 'penghuni.id_user')

        ->leftJoin('pengurus', 'pengurus.id_user', '=', 'pembayaran.id_pengurus')
        ->leftJoin('datausers as data_pengurus', 'data_pengurus.id_user', '=', 'pengurus.id_user')
