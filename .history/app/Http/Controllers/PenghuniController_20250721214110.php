...
$data = Penghuni::select([
        ...
        'penghuni.created_at as penghuni_created_at',
        'penghuni.updated_at as penghuni_updated_at',

        'datausers.id_user as datauser_id',
        'datausers.nama',
        'datausers.no_ktp',
        'datausers.no_hp',
        'datausers.alamat',
        ...
        'datausers.password',
        'datausers.tipe_user',
        'datausers.created_at as datauser_created_at',
        'datausers.updated_at as datauser_updated_at',
    ])
