...
class KamarController extends Controller
{
    ...
    {
        $data = SukuCadang::select([
            'sukucadangs.Id_SukuCadang',
            'sukucadangs.Id_DataUser',
            'datausers.Nama_Lengkap',
            'sukucadangs.TanggalTransaksi',
            'sukucadangs.NamaBarang',
            'sukucadangs.Qty',
            'sukucadangs.NominalHarga',
            'sukucadangs.Catatan',
            'sukucadangs.Status',
            'sukucadangs.NamaCEO',
            'sukucadangs.DivisiKeuangan',
        ])
        ->join('datausers', 'datausers.Id_DataUser', '=', 'sukucadangs.Id_DataUser')
        ->where('Id_SukuCadang', $idSukuCadang)
        ->get();
        return view('Menu.SukuCadang.Pengajuan.edit', compact('data'));
    }
