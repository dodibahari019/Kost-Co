...
class PindahKamarController extends Controller
{
    ...
    public function viewPindahKaamr()
    {
        return view('Menu.PindahKamar.Data.table');
    }

    public function getViewPindahKaamr()
    {
        $tanggalHariIni = Carbon::now()->format('Y-m-d');
    ...
    public function dataTableViewPindahKaamr()
    {
        return view('Menu.PindahKamar.Data.table');
    }

    public function isidataTableViewPindahKaamr(Request $request)
    {
