...
class TPindahKamarController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Menu.PengajuanPindahKamar.index', compact('tanggalHariIni', 'idUser', 'namaLengkap', 'tipeUser', 'data', 'listOfKamar'));
    }
    ...
    public function store(Request $request)
    {
        try{
            ...
            // Cari ID terakhir
            $lastTransaksi = PindahKamar::orderBy('id_kamar', 'desc')->first();
