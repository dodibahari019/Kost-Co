    ...
    public function getViewPenghuni()
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($row) {
                $btn = '<button type="button" action="/mobil-masuk/edit/'.$row->Id_InputPengeluaranMobilTemp.'" style="width:30px; height:30px; display: flex; justify-content: center; align-items: center;" class="btn btn-warning bg-gradient-warning modal-crud" id="data-editInputPengeluaran-form-btn" title="Data | Edit Form">
