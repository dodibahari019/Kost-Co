    ...
    public function getLastNomorKamar(Request $request)
{
    ...
    // Ambil nomor terakhir berdasarkan tipe
    $lastKamar = DB::table('kamar')
        ->where('tipe', $tipe)
        ->orderBy('nomor_kamar', 'desc')
        ->first();

    // Misal formatnya A019 atau R005, ambil angka belakang lalu tambah 1
    $prefix = strtoupper(substr($tipe, 0, 1)); // misal P untuk Premium, R untuk Reguler
