...
class KamarController extends Controller
{
    ...
    public function getLastNomorKamar(Request $request)
    {
        ...
        $prefix = $prefixMap[$tipe] ?? 'X'; // Default X jika tipe tidak dikenal

        // Ambil nomor kamar terakhir berdasarkan prefix
        ...
        // Tambah 1 dan format jadi 3 digit
