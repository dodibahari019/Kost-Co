       ...
       $query = Kamar::select([
        ...
        if ($request->has('namaKamar') && $request->namaKamar != '') {
            ...
            $query->where(function ($q) use ($keyword) {
                $q->where('kamar.nama', 'LIKE', "%$keyword%")
                ->orWhere('kamar.no_ktp', 'LIKE', "%$keyword%")
                ->orWhere('kamar.no_hp', 'LIKE', "%$keyword%")
                ->orWhere('kamar.alamat', 'LIKE', "%$keyword%")
                ->orWhere('kamar.email', 'LIKE', "%$keyword%")
                ->orwhere('kamar.status_penghuni', 'LIKE', "%$keyword%");
            });
        }
