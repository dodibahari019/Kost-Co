...
Route::controller(SewaKamarController::class)->group(function(){
    ...
    // DATATABLE
    Route::get('/pengelolaan-sewa-kamar/viewPenghuni', 'viewPenghuni');
    Route::get('/pengelolaan-sewa-kamar/getViewPenghuni', 'getViewPenghuni');
    Route::get('/pengelolaan-sewa-kamar/dataTableViewPenghuni', 'dataTableViewPenghuni');
    Route::get('/pengelolaan-sewa-kamar/isidataTableViewPenghuni', 'isidataTableViewPenghuni');
    // CRUD
    Route::get('/pengelolaan-sewa-kamar/edit/{idPenghuni}', 'edit');
    Route::put('/pengelolaan-sewa-kamar/update/{idPenghuni}', 'update');
});
