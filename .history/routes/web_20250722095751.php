...
Route::controller(KamarController::class)->group(function(){
    ...
    // DATATABLE
    Route::get('/kamar/viewKamar', 'viewKamar');
    Route::get('/kamar/getViewKamar', 'getViewKamar');
    Route::get('/kamar/dataTableViewKamar', 'dataTableViewKamar');
    Route::get('/kamar/isidataTableViewKamar', 'isidataTableViewKamar');
    // CRUD
    Route::get('/kamar/edit/{idKamar}', 'edit');
    Route::put('/kamar/update/{idKamar}', 'update');
});
