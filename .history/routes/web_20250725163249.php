...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['penghuni'])->group(function () {
        ...
        Route::controller(TCheckOutController::class)->group(function(){
            ...
            // DATATABLE
            Route::get('/pengajuan-checkout/viewPengajuanPindahKamar', 'viewPengajuanPindahKamar');
            Route::get('/pengajuan-checkout/getViewPengajuanPindahKamar', 'getViewPengajuanPindahKamar');
            // CRUD
