...
Route::controller(AuthController::class)->group(function(){
    Route::get('/loginUser', 'loginView')->name('loginUser');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['pengurus'])->group(function () {
        ...
        Route::controller(PindahKamarController::class)->group(function(){
            Route::get('/pengelolaan-ajuan-pindah-kamar', 'index');
            // DATATABLE
            Route::get('/pengelolaan-ajuan-pindah-kamar/viewPindahKamar', 'viewPindahKamar');
            Route::get('/pengelolaan-ajuan-pindah-kamar/getViewPindahKamar', 'getViewPindahKamar');
            Route::get('/pengelolaan-ajuan-pindah-kamar/dataTableViewPindahKamar', 'dataTableViewPindahKamar');
            Route::get('/pengelolaan-ajuan-pindah-kamar/isidataTableViewPindahKamar', 'isidataTableViewPindahKamar');
            // CRUD
            Route::get('/pengelolaan-ajuan-pindah-kamar/edit/{idPindah}', 'edit');
            Route::put('/pengelolaan-ajuan-pindah-kamar/update/{idPindah}', 'update');
        });
    });
