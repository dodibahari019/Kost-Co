...
Route::controller(KamarController::class)->group(function(){
    ...
    // DATATABLE
    Route::get('/kamaar/viewPenghuni', 'viewPenghuni');
    Route::get('/kamaar/getViewPenghuni', 'getViewPenghuni');
    Route::get('/kamaar/dataTableViewPenghuni', 'dataTableViewPenghuni');
    Route::get('/kamaar/isidataTableViewPenghuni', 'isidataTableViewPenghuni');
    // CRUD
    Route::get('/kamaar/edit/{idPenghuni}', 'edit');
    Route::put('/kamaar/update/{idPenghuni}', 'update');
});
