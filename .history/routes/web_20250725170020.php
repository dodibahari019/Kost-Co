...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['penghuni'])->group(function () {
        ...
        Route::controller(TPerbaikanController::class)->group(function(){
            ...
            // DATATABLE
            Route::get('/pengajuan-perbaikan/viewPengajuanPindahKamar', 'viewPengajuanPindahKamar');
            Route::get('/pengajuan-perbaikan/getViewPengajuanPindahKamar', 'getViewPengajuanPindahKamar');
            // CRUD
