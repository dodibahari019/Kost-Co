...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['pengurus'])->group(function () {
        ...
        Route::controller(PindahKamarController::class)->group(function(){
            ...
            // DATATABLE
            Route::get('/pengelolaan-ajuan-pindah-kamar/viewSewaKamar', 'viewSewaKamar');
            Route::get('/pengelolaan-ajuan-pindah-kamar/getViewSewaKamar', 'getViewSewaKamar');
            Route::get('/pengelolaan-ajuan-pindah-kamar/dataTableViewSewaKamar', 'dataTableViewSewaKamar');
            Route::get('/pengelolaan-ajuan-pindah-kamar/isidataTableViewSewaKamar', 'isidataTableViewSewaKamar');
            // CRUD
            Route::get('/pengelolaan-ajuan-pindah-kamar/edit/{idSewaKamar}', 'edit');
            Route::put('/pengelolaan-ajuan-pindah-kamar/update/{idSewaKamar}', 'update');
        });
    });
