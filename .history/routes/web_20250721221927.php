...
Route::controller(PenghuniController::class)->group(function(){
    ...
    Route::get('/pengelolaan-penghuni/dataTableViewJualMobil', 'dataTableViewJualMobil');
    Route::get('/pengelolaan-penghuni/isidataTableViewJualMobil', 'isidataTableViewJualMobil');
});
