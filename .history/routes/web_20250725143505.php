...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['penghuni'])->group(function () {
        ...
        Route::controller(TPindahKamarController::class)->group(function(){
            ...
            // DATATABLE
            Route::get('/pengajuan-pindah-kamar/getViewPengajuanPindahKamar', 'viewListKamar');
            Route::get('/pengajuan-pindah-kamar/getViewPengajuanPindahKamar', 'getViewListKamar');
        });
