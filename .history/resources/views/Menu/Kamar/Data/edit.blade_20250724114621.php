    ...
    <div class="card-body" style="padding: 3px;">
        <div class="row">
            ...
            <div class="col-6 mt-2">
                ...
                <input value="" onkeydown="EnterButtonKamarIsStartingEdit(event)" type="text" name="hargaSewa" id="hargaSewaEdit" class="form-control text-right classRp">
            </div>
...
@endforeach
<script>
    function CheckLastNomorKamarEdit(tipeEdit) {
        if (tipe !== "") {
            $.ajax({
                ...
                success: function (response) {
                    // Update nilai input
                    $('#nomorKamarEdut').val(response.nomor_baru);
                },
                error: function () {
