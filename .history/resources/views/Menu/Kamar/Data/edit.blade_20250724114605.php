    ...
    <div class="card-body" style="padding: 3px;">
        <div class="row">
            <div class="col-12">
                ...
                <select onchange="CheckLastNomorKamar(thisEdit.value)" onkeydown="EnterButtonKamarIsStartingEdit(event)" name="tipeKamar" id="tipeKamarEdit" class="form-group form-control" aria-label="Default select example">
...
@endforeach
<script>
    function CheckLastNomorKamar(tipeEdit) {
        if (tipe !== "") {
            $.ajax({
