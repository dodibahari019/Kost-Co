    ...
    <div class="card-body" style="padding: 3px;">
        <div class="row">
            <div class="col-12">
                ...
                <select onchange="CheckLastNomorKamarEdit(thisEdit.value)" onkeydown="EnterButtonKamarIsStartingEdit(event)"  class="form-group form-control" aria-label="Default select example">
