    ...
    <div class="card-body" style="padding: 3px;">
        <div class="row">
            ...
            <div class="col-6 mt-2">
                ...
                <input value="{{number_format($x->harga_sewa,0,',' , '.')}}" onkeydown="EnterButtonKamarIsStartingEdit(event)" type="text" name="hargaSewa" id="hargaSewaEdit" class="form-control text-right classRp">
            </div>
