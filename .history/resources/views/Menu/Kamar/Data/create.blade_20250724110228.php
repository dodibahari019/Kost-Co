    ...
    <div class="card-body" style="padding: 3px;">
        <div class="row">
            <div class="mb-1 col-12">
                <label for="status" class="form-label fw-semibold">Tipe Kamar</label>
                <select onchange="CheckLastNomorKamar()" name="status" id="statusEdit" class="form-group form-control" aria-label="Default select example">
            ...
            <div class="mb-1 col-12">
                <label for="noktp" class="form-label fw-semibold">Nomor Kamar</label>
                <input type="text" readonly name="nomorKamar" id="noktpEdit" style="font-weight: bold;" class="form-control">
            </div>

            <div class="mb-1 col-6">
                <label for="namapenghuni" class="form-label fw-semibold">Ukuran</label>
                <input type="text" name="namapenghuni" id="namapenghuniEdit" class="form-control">
            </div>

            <div class="mb-1 col-6">
                <label for="nohp" class="form-label fw-semibold">Harga Sewa</label>
                <input type="text" name="nohp" id="nohpEdit" class="form-control text-right classRp">
            </div>

            <div class="mb-1 col-12">
                <label for="nohp" class="form-label fw-semibold">Status Kamar</label>
                <input readonly value="Tersedia" type="text" name="nohp" id="nohpEdit" class="form-control">
            </div>
      ...
      <div class="row">
        <div class="col-12 mt-3" style="justify-content:flex-end; display:flex;">
            <button onclick="ButtonSumbitIsRunningPenghuniEdit()" type="button" style="width:120px; text-align:center; font-weight:600; background-color: #343a40;" class="btn btn-primary">Simpan</button>
            <button hidden type="submit" id="RealSubmitButtonPenghuniEdit" style="width:120px; text-align:center; font-weight:600; background-color: #343a40;" class="btn btn-primary">Simpan</button>
        </div>
      </div>
    </div>
</form>
<script>
    function CheckLastNomorKamar(){
