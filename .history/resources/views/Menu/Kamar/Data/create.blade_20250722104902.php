    ...
    <div class="card-body" style="padding: 3px;">
        <div class="row">
            ...
            <div class="mb-1 col-6">
                ...
                <input value="{{ $x->nama }}" type="text" name="namapenghuni" id="namapenghuniEdit" class="form-control">
            </div>

            <div class="mb-1 col-6">
                <label for="nohp" class="form-label fw-semibold">No. HP</label>
                <input value="{{ $x->no_hp}}" type="text" name="nohp" id="nohpEdit" class="form-control">
            </div>

            <div class="mb-1 col-6">
                <label for="email" class="form-label fw-semibold">Email</label>
                <input value="{{ $x->email }}" type="text" name="email" id="emailEdit" class="form-control">
            </div>
