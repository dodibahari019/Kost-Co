    ...
    <div class="card-body" style="padding: 3px;">
        <div class="row">
            <div class="col-12">
                ...
                <select onchange="CheckLastNomorKamar(this.value)" onkeydown="EnterButtonKamarIsStartingEdit(event)" name="tipeKamar" id="tipeKamarEdit" class="form-group form-control" aria-label="Default select example">
