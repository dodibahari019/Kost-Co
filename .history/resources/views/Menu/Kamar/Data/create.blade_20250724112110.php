    ...
    <div class="card-body" style="padding: 3px;">
        <div class="row">
            <div class="col-12">
                ...
                <select onchange="CheckLastNomorKamar(this.value)" name="status" id="statusEdit" class="form-group form-control" aria-label="Default select example">
...
<script>
    function EnterButtonIsRunningNowKamar(event){
        if(event.key == "Enter" || event.keyCode == 13){
            event.preventDefault();
            ButtonSumbitIsRunningKamar();
        }
    }
</script>
<script>
    ...
    function ButtonSumbitIsRunningKamar() {
        ...
        //     showAlert("Format Tanggal harus YYYY-MM-DD!");
            ...
            document.getElementById('RealSubmitButtonKamar').click();
        }
    }
</script>
<script>
