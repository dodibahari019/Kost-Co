    ...
    <div class="card-body" style="padding: 3px;">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <input type="text" value="{{ $x->nomor_kamar }}" readonly name="nomorKamar" id="nomorKamar" style="font-weight: bold;" class="form-control">
            </div>

            <div class="col-6 mt-2">
                <label for="ukuran" class="form-label fw-semibold">Ukuran</label>
                <input value="{{ $x->ukuran }}" onkeydown="EnterButtonKamarIsStarting(event)" type="text" name="ukuran" id="ukuran" class="form-control">
            </div>

            <div class="col-6 mt-2">
                <label for="hargaSewa" class="form-label fw-semibold">Harga Sewa</label>
                <input value="" onkeydown="EnterButtonKamarIsStarting(event)" type="text" name="hargaSewa" id="hargaSewa" class="form-control text-right classRp">
            </div>
            ...
            <div class="col-12">
                <label for="statusKamar" class="form-label fw-semibold">Status Kamar</label>
                <select name="statusKamar" id="statusKamar" class="form-group form-control" aria-label="Default select example">
