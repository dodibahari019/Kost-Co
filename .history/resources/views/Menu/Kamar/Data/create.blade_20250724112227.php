    ...
    <div class="card-body" style="padding: 3px;">
        <div class="row">
            <div class="col-12">
                ...
                <select onchange="CheckLastNomorKamar(this.value)" onkeydown="EnterButtonKamarIsStarting(event)" name="tipeKamar" id="statusEdit" class="form-group form-control" aria-label="Default select example">
            ...
            <div class="col-6 mt-2">
                ...
                <input onkeydown="EnterButtonKamarIsStarting(event)" type="text" name="namapenghuni" id="namapenghuniEdit" class="form-control">
            </div>

            <div class="col-6 mt-2">
                <label for="nohp" class="form-label fw-semibold">Harga Sewa</label>
                <input onkeydown="EnterButtonKamarIsStarting(event)" type="text" name="nohp" id="nohpEdit" class="form-control text-right classRp">
            </div>
