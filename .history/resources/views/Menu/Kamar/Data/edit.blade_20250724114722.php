    ...
    <div class="card-body" style="padding: 3px;">
        <div class="row">
            <div class="col-12">
                ...
                <select onchange="CheckLastNomorKamarEdit(thisEdit.value)" onkeydown="EnterButtonKamarIsStartingEdit(event)" name="tipeKamar" id="tipeKamarEdit" class="form-group form-control" aria-label="Default select example">
            ...
            <div class="col-6 mt-2">
                ...
                <input value="{{number_format($x->NominalHarga,0,',' , '.')}}" onkeydown="EnterButtonKamarIsStartingEdit(event)" type="text" name="hargaSewa" id="hargaSewaEdit" class="form-control text-right classRp">
            </div>
...
@endforeach
<script>
    function CheckLastNomorKamarEdit(tipe) {
        if (tipe !== "") {
            $.ajax({
                ...
                success: function (response) {
                    // Update nilai input
                    $('#nomorKamarEdit').val(response.nomor_baru);
                },
                error: function () {
