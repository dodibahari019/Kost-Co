<form action="/pegelolaan-kamar/store" class="windowForm postClass" id="CreateFormX" dataTableId="#DataPengecekanTableId" enctype="multipart/form-data" method="post">
    @csrf
    <div class="card-body" style="padding: 3px;">
        <div class="row">
            ...
            <div class="mb-1 col-6">
                ...
                <input type="text" name="nohp" id="nohpEdit" class="form-control">
            </div>

            <div class="mb-1 col-12">
                <label for="status" class="form-label fw-semibold">Status Kamar</label>
                <select read name="status" id="statusEdit" class="form-group form-control" aria-label="Default select example">
                    <option selected></option>
