...
<script>
    ...
    function tblViewDataPenghuni(not) {
        var url = not == undefined ? "/pengelolaan-penghuni/isidataTableViewPenghuni" : "/pengelolaan-penghuni/isidataTableViewPenghuni?namaKamar=" + encodeURIComponent(not.valP) ;
