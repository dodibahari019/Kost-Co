...
<script>
    $(document).on("submit", "#frmViewDataPenghuni", function(e) {
        ...
        var not = {valP: valP}
        $.get("/pengelolaan-penghuni/dataTableViewPenghuni", function(tbl) {
    ...
    function tblViewDataPenghuni(not) {
        var url = not == undefined ? "/pengelolaan-penghuni/isidataTableViewPenghuni" : "/pengelolaan-penghuni/isidataTableViewPenghuni?namaPenghuni=" + encodeURIComponent(not.valP) ;
