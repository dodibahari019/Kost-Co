    ...
    var dataTableData = [
        {
            ...
            url : "/pengelolaan-penghuni/getViewMobilMasuk",
            method : "GET",
            noBtnPrint: true,
            bPaginate: true,
            responsive: true,
    ...
    var dataTableDataInputPengeluaran = [
        {
            ...
            dom: 'Bfrtip',
            btnNames : ['excelHtml5', 'pdfHtml5', 'print'],
            url : "/pengelolaan-penghuni/getViewInputPengeluaran",
            method : "GET",
            noBtnPrint: true,
            bPaginate: true,
            responsive: true,
    ...
    var dataTableDataHistoryPengeluaran = [
        {
            ...
            dom: 'Bfrtip',
            btnNames : ['excelHtml5', 'pdfHtml5', 'print'],
            url : "/pengelolaan-penghuni/getViewHistoryPengeluaran",
            method : "GET",
            noBtnPrint: true,
            bPaginate: true,
            responsive: true,
...
<script>
    $(document).ready(function(){
        var id = $('#cardContentData'),
            url = "/pengelolaan-penghuni/viewMobilMasuk";
    ...
    $(document).ready(function(){
        var id = $('#cardContentDataInputPengeluaran'),
            url = "/pengelolaan-penghuni/viewInputPengeluaran";
        $.get(url, function(table) {
                $(id).html(table);
                // alert('ola');
                var val = {_token:'', value:'', method:'POST'}
    ...
    $(document).ready(function(){
        var id = $('#cardContentDataHistoryPengeluaran'),
            url = "/pengelolaan-penghuni/viewHistoryPengeluaran";
        $.get(url, function(table) {
                $(id).html(table);
                // alert('ola');
                var val = {_token:'', value:'', method:'POST'}
...
<script>
    ...
    <script>
        $(document).on("submit", "#frmViewDataInputPengeluaran", function(e) {
            ...
            $.get("/pengelolaan-penghuni/dataTableViewInputPemasukan", function(tbl) {
        ...
        function tblViewDataInputPemasukan(not) {
            var url = not == undefined ? "/pengelolaan-penghuni/isidataTableViewInputPemasukan" : "/pengelolaan-penghuni/isidataTableViewInputPemasukan?tanggalAwal=" + encodeURIComponent(not.valP) + "&tanggalAkhir=" + encodeURIComponent(not.valQ) + "&namaMerk=" + encodeURIComponent(not.valR);
    ...
    <script>
        ...
        var valR = $('#' + id + ' input[name="namaMerk"]').val();
        var not = {valP: valP, valQ: valQ, valR: valR}
        $.get("/pengelolaan-penghuni/dataTableViewHistoryPengeluaran", function(tbl) {
    ...
    function tblViewDataHistoryMobilMasuk(not) {
        var url = not == undefined ? "/pengelolaan-penghuni/isidataTableViewHistoryPengeluaran" : "/pengelolaan-penghuni/isidataTableViewHistoryPengeluaran?tanggalAwal=" + encodeURIComponent(not.valP) + "&tanggalAkhir=" + encodeURIComponent(not.valQ) + "&namaMerk=" + encodeURIComponent(not.valR);
