    ...
    <div class="card-body" style="padding: 5px;">
        <div class="row">
            ...
            <div class="mb-1 col-6">
                <label for="qty" class="form-label fw-semibold">No</label>
            ...
            <div class="mb-1 col-6">
                ...
                <input value="{{ $x->NamaBarang }}" type="text" onkeydown="EnterButtonIsRunningNowSukuCadangEdit(event)" name="harga" id="hargaEdit" class="form-control">
            </div>

            <div class="mb-1 col-12">
                <label for="harga" class="form-label fw-semibold">Subtotal</label>
                <input value="{{number_format($x->Qty * $x->NominalHarga,0,',' , '.')}}" type="text" readonly id="idSubtotalEdit" class="form-control">
            </div>
