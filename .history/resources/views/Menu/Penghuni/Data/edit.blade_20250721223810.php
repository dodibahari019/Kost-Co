    ...
    <div class="card-body" style="padding: 5px;">
        <div class="row">
            <div class="mb-1 col-12">
                <label for="notkp" class="form-label fw-semibold">No KTP</label>
                <input value="{{ $x->no_ktp }}" type="text" onkeydown="EnterButtonIsRunningNowSukuCadangEdit(event)" name="notkp" id="notkpEdit" class="form-control">
            </div>
            ...
            <div class="mb-1 col-12">
                ...
                <input value="{{ $x->email }}" onkeydown="EnterButtonIsRunningNowSukuCadangEdit(event)" type="text" name="qty" id="qtyEdit" class="form-control">
            </div>
