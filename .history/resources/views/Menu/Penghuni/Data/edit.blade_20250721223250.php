@foreach ($data as $x)
<form action="/suku-cadang/update/{{ $x->Id_SukuCadang }}" class="windowForm postClassX" id="editForm" dataTableId="#DataSukuCadangTableId" enctype="multipart/form-data" method="post">
    @csrf
    @method('put')
