    ...
    <div class="card-body" style="padding: 5px;">
        <div class="row">
            <div class="mb-1 col-12">
                <label for="no" class="form-label fw-semibold">No KTP</label>
                <input value="{{ $x->no_ktp }}" type="text" onkeydown="EnterButtonIsRunningNowSukuCadangEdit(event)" name="no" id="noEdit" class="form-control">
            </div>
