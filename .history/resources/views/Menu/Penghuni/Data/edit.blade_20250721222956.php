@foreach ($data as $x)
<form action="/pengelolaan-penghuni/{{ $x->Id_Pengecekan }}" class="windowForm postClassX" id="editForm" dataTableId="#DataPengecekanTableId" enctype="multipart/form-data" method="post">
    @csrf
    @method('put')
