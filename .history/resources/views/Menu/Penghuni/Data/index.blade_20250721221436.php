<div id="ButtonPenghuni">
    <div id="TabButtonTop" style="display: flex; flex-wrap: nowrap; gap: 10px; align-items: center;">
        ...
        <div style="flex: 0 0 auto;">
            <button onclick="RunTheButtonSearchPenghuni()" type="button" class="btn btn-primary">
        ...
        <form class="windowForm" id="frmViewDataPenghuni">
            ...
            <div class="form-group mt-2">
                <div class="input-group">
                    <input type="date" value="{{ $tanggalHariIni }}" name="tanggalAwal" class="form-control" id="idFillTheVoidTanggalAwalPenghuni" style="text-transform:uppercase;" autocomplete="off">
                </div>
                <div class="input-group">
                    <input type="date" value="{{ $tanggalHariIni }}" name="tanggalAkhir" class="form-control" id="idFillTheVoidTanggalAkhirPenghuni" style="text-transform:uppercase;" autocomplete="off">
                </div>
                <div class="input-group">
