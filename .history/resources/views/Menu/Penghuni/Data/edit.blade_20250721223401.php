    ...
    <div class="card-body" style="padding: 5px;">
        <div class="row">
            ...
            <div class="mb-1 col-6">
                ...
                <input value="{{ $x->NamaBarang }}" onkeydown="EnterButtonIsRunningNowSukuCadangEdit(event)" type="text" name="qty" id="qtyEdit" class="form-control classRp text-right">
            </div>

            <div class="mb-1 col-6">
                <label for="harga" class="form-label fw-semibold">Harga Satuan</label>
                <input value="{{number_format($x->NominalHarga,0,',' , '.')}}" type="text" onkeydown="EnterButtonIsRunningNowSukuCadangEdit(event)" name="harga" id="hargaEdit" class="form-control classRp text-right">
            </div>
