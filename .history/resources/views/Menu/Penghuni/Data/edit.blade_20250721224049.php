...
<form action="/pengelolaan-penghuni/update/{{ $x->id_penghuni }}" class="windowForm postClassX" id="editForm" dataTableId="#DataPenghuniTableId" enctype="multipart/form-data" method="post">
    ...
    <div class="card-body" style="padding: 5px;">
        <div class="row">
            ...
            <div class="mb-1 col-612">
                <label style="font-weight: 700" class="formLabel mb-1 mt-2">Status Asal</label>
                <select onkeydown="EnterButtonIsRunningNow(event)" name="statusasal" id="id4StatusAsal" class="form-group form-control" aria-label="Default select example">
