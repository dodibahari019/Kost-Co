    ...
    <div class="card-body" style="padding: 5px;">
        <div class="row">
            ...
            <div class="mb-1 col-6">
                ...
                <input value="{{}}" oninput="hitungSubtotalEdit()" onkeydown="EnterButtonIsRunningNowSukuCadangEdit(event)" type="text" name="qty" id="qtyEdit" class="form-control classRp text-right">
            </div>
