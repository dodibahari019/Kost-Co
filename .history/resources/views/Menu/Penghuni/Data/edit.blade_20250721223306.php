@foreach ($data as $x)
<form action="/pengelolaan-penghuni/update/{{ $x->id_penghuni }}" class="windowForm postClassX" id="editForm" dataTableId="#DataSukuCadangTableId" enctype="multipart/form-data" method="post">
    @csrf
    @method('put')
