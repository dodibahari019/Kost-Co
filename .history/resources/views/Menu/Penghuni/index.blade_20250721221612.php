...
<script>
    ...
    function FillTheVoidOfThisStartDate(tanggalAwal){
        document.getElementById('idFillTheVoidTanggalAwalPenghuni').value = tanggalAwal
    }

    function FillTheVoidOfThisEndtDate(tanggalAkhir){
        document.getElementById('idFillTheVoidTanggalAkhirPenghuni').value = tanggalAkhir
    }
    ...
    function FillTheVoidPenghuniPengeluaran(x){
    ...
    function FillTheVoidOfTanggalAwal(x){
        document.getElementById('idFillTheVoidTanggalAwalHistoryPengeluaranPenghuni').value = x
    }

    function FillTheVoidOfTanggalAkhir(y){
        document.getElementById('idFillTheVoidTanggalAkhirHistoryPengeluaranPenghuni').value = y
    }

    function FillTheVoidOfPenghuni(x){
        document.getElementById('idFillTheVoidInputPengeluaranPenghuni').value = x
    }

    function EnterRunningNowInputPemasukanMobiMasuk(event){
        if (event.key == 'Enter' || event.keyCode == 13){
            event.preventDefault();
            RunTheButtonSearchInputPengeluaranPenghuni();
        }
    }

    function RunTheButtonSearchInputPengeluaranPenghuni(){
        document.getElementById('idButtonVoidInputPengeluaranPenghuni').click();
    }

    function FillTheVoidOfTanggalAwalHistory(x){
        document.getElementById('idFillTheVoidTanggalAwalPengeluaranPenghuni').value = x;
    }

    function FillTheVoidOfTanggalAkhirHistory(y){
        document.getElementById('idFillTheVoidTanggalAkhirPengeluaranPenghuni').value = y
    }

    function FillTheVoidOfPenghuniHistory(x){
        document.getElementById('idFillTheVoidPengeluaranPenghuniHistory').value = x
    }

    function EnterRunningNowInputPemasukanMobiMasukHistory(event){
        if (event.key == 'Enter' || event.keyCode == 13){
            event.preventDefault();
            RunTheButtonSearchInputPengeluaranPenghuniHistory();
        }
    }

    function RunTheButtonSearchInputPengeluaranPenghuniHistory(){
        document.getElementById('idButtonVoidPenghuniHistory').click();
    }
