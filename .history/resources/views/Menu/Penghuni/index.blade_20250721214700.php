...
<script>
    $(document).on("submit", "#frmViewDataMobilMasuk", function(e) {
        ...
        $.get("//dataTableView", function(tbl) {
    ...
    function tblViewDataMobilMasuk(not) {
        var url = not == undefined ? "//isidataTableView" : "//isidataTableView?namaMerk=" + encodeURIComponent(not.valP) + "&tanggalAwal=" + encodeURIComponent(not.valAw) + "&tanggalAkhir=" + encodeURIComponent(not.valAk) +"";
    ...
    <script>
        $(document).on("submit", "#frmViewDataInputPengeluaran", function(e) {
            ...
            $.get("//dataTableViewInputPemasukan", function(tbl) {
        ...
        function tblViewDataInputPemasukan(not) {
            var url = not == undefined ? "//isidataTableViewInputPemasukan" : "//isidataTableViewInputPemasukan?tanggalAwal=" + encodeURIComponent(not.valP) + "&tanggalAkhir=" + encodeURIComponent(not.valQ) + "&namaMerk=" + encodeURIComponent(not.valR);
    ...
    <script>
        ...
        var valR = $('#' + id + ' input[name="namaMerk"]').val();
        var not = {valP: valP, valQ: valQ, valR: valR}
        $.get("//dataTableViewHistoryPengeluaran", function(tbl) {
    ...
    function tblViewDataHistoryMobilMasuk(not) {
        var url = not == undefined ? "//isidataTableViewHistoryPengeluaran" : "//isidataTableViewHistoryPengeluaran?tanggalAwal=" + encodeURIComponent(not.valP) + "&tanggalAkhir=" + encodeURIComponent(not.valQ) + "&namaMerk=" + encodeURIComponent(not.valR);
