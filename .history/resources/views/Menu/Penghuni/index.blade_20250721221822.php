...
<script>
    $(document).on("submit", "#frmViewDataPenghuni", function(e) {
        ...
        var valP = $('#' + id + ' input[name="namaPe"]').val();
        var not = {valP: valP}
    ...
    function tblViewDataPenghuni(not) {
        var url = not == undefined ? "/pengelolaan-penghuni/isidataTableView" : "/pengelolaan-penghuni/isidataTableView?namaPe=" + encodeURIComponent(not.valP) ;
