<div class="row g-4">
    <div class="col-5 vh-100" style="background-color: #ebebeb;">
    ...
    <div class="col-7 vh-100 py-3" style="display: flex; border: 3px solid #ebebeb; flex-wrap: nowrap; gap: 10px; align-items: flex-start;">
        <div style="flex:1;">
