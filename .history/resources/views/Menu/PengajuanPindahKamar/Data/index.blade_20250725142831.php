    ...
    @foreach($data as $key => $x)
        <div class="col-5 vh-100" style="background-color: #efefef;">
            <div class="col-12 mt-3">
                ...
                <input value="{{ $x-> }}" type="text" name="nomorKamar" id="nomorKamar" style="font-weight: bold;" class="form-control">
            </div>
            <div class="col-12 mt-3">
            ...
            <div class="col-12 mt-3">
                ...
                <input value="{{ $x-> }}" type="text" name="kamarAsal" id="kamarAsal" style="font-weight: bold;" class="form-control">
            </div>
            <div class="col-12 mt-3">
