        ...
        @csrf
            <div class="col-5 vh-100" style="background-color: #efefef;">
                ...
                <div class="col-12 mt-3">
                    ...
                    <input type="text" name="kamarTujuan" id="kamarTujuan" style="font-weight: 600;" class="form-control">
                </div>
                <div class="col-12 mt-3">
                ...
                <div class="col-12 mt-3">
                    <button type="button" onclick="ValidasiDataDataIni(this)" class="btn btn-outline-dark w-100">Simpan</button>
                    <button hidden type="submit" class="btn btn-outline-dark w-100">Simpan</button>
                </div>
            </div>
        </form>
    @endforeach
