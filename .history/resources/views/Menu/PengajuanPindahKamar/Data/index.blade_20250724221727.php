<div class="row g-4">
    <div class="col-5 vh-100" style="background-color: #e6e6e6;">
    ...
    <div class="col-7 vh-100 py-3" style="display: flex; border: 3px solid #e6e6e6; flex-wrap: nowrap; gap: 10px; align-items: flex-start;">
        <div style="flex:1;">
