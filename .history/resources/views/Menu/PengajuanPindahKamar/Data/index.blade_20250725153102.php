        ...
        @csrf
            <div class="col-5 vh-100" style="background-color: #efefef;">
                ...
                <div class="col-12 mt-3">
                    ...
                    <button hidden type="submit" id="RealSubmitButtonPindahKamarId" class="btn btn-outline-dark w-100">Simpan</button>
                </div>
            </div>
        </form>
    @endforeach
...
<script>
    ...
    function JalankanValidasiData() {
        ...
        if (!kamarTujuan) {
            ...
            document.getElementById('RealSubmitButtonPindahKamarId').click();
        }
    }
</script>