    ...
    @foreach($data as $key => $x)
        <div class="col-5 vh-100" style="background-color: #efefef;">
            <div class="col-12 mt-3">
                ...
                <input value="{{ $x->nama }}" type="text" name="nomorKamar" id="nomorKamar" style="font-weight: bold;" class="form-control">
            </div>
            <div class="col-12 mt-3">
                <label for="nomorKamar" class="form-label fw-semibold">Email</label>
                <input value="{{ $x->email }}" type="text" name="nomorKamar" id="nomorKamar" style="font-weight: bold;" class="form-control">
            </div>
            <div class="col-12 mt-3">
                <label for="nomorKamar" class="form-label fw-semibold">No Hp</label>
                <input value="{{ $x->no_hp }}" type="text" name="nomorKamar" id="nomorKamar" style="font-weight: bold;" class="form-control">
            </div>
            <div class="col-12 mt-3">
                <label for="kamarAsal" class="form-label fw-semibold">Nomor Kamar Asal</label>
                <input value="{{ $x->nomor_kamar }}" type="text" name="kamarAsal" id="kamarAsal" style="font-weight: bold;" class="form-control">
            </div>
            <div class="col-12 mt-3">
