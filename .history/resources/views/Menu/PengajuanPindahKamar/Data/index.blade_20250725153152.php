        ...
        @csrf
            <div class="col-5 vh-100" style="background-color: #efefef;">
                ...
                <div class="col-12 mt-3">
                    ...
                    <input type="text" onkeydown="" name="kamarTujuan" id="kamarTujuan" style="font-weight: 600;" class="form-control">
                </div>
                <div class="col-12 mt-3">
                    <label for="catatan" class="form-label fw-semibold">Catatan</label>
                    <textarea onkeydown="" name="catatan" class="form-control" id="catatan"></textarea>
                </div>
                <div class="col-12 mt-3">
