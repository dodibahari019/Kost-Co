<div class="row g-4">
    @foreach($data as $key => $x)
        <form action="/pengajuan-pindah-kamar/store" class="windowForm postClass" id="CreateFormX" dataTableId="#DataKamarTableId" enctype="multipart/form-data" method="post">
        @csrf
            <div class="col-5 vh-100" style="background-color: #efefef;">
                <div class="col-12 mt-3">
                    <label for="nomorKamar" class="form-label fw-semibold">Nama</label>
                    <input readonly value="{{ $x->nama }}" type="text" name="nomorKamar" id="nomorKamar" style="font-weight: 600;" class="form-control">
                </div>
                <div class="col-12 mt-3">
                    <label for="nomorKamar" class="form-label fw-semibold">Email</label>
                    <input readonly value="{{ $x->email }}" type="text" name="nomorKamar" id="nomorKamar" style="font-weight: 600;" class="form-control">
                </div>
                <div class="col-12 mt-3">
                    <label for="nomorKamar" class="form-label fw-semibold">No Hp</label>
                    <input readonly value="{{ $x->no_hp }}" type="text" name="nomorKamar" id="nomorKamar" style="font-weight: 600;" class="form-control">
                </div>
                <div class="col-12 mt-3">
                ...
                <div class="col-12 mt-3">
                    <label for="kamarAsal" class="form-label fw-semibold">Nomor Kamar Tujuan</label>
                    <input type="text" name="kamarAsal" id="kamarAsal" style="font-weight: 600;" class="form-control">
                </div>
                <div class="col-12 mt-3">
    ...
    <div class="col-7 vh-100 py-3" style="border: 3px solid #efefef;">
        ...
        <div id="cardContentDataPengajuanPindahKamar" style="overflow-x: auto;">
