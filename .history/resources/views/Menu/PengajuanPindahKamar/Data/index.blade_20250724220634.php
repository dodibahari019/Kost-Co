<div class="row g-4">
    <div class="col-6 vh-100 row" style="background-color: #e6e6e6;">
        <div class="col-12">
        ...
        <div class="col-12">
            <label for="nomorKamar" class="form-label fw-semibold">Catatan</label>
            <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea"></textarea>
        </div>
    </div>
    <div class="col-6 vh-100 row" style="border: 3px solid #e6e6e6;">
