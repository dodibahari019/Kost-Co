...
<script>
    ...
    function RunTheButtonSearchPerbaikan(){
        document.getElementById('idButtonVoidPerbaikan').click();
    }

    function EnterRunningNowPerbaikan(event){
        if (event.key == 'Enter' || event.keyCode == 13){
            event.preventDefault();
            RunTheButtonSearchPerbaikan();
        }
    }
    </script>
<script>
