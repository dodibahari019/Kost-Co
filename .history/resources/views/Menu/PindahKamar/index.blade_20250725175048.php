...
<script>
    ...
    function tblViewDataPerbaikan(not) {
        var url = not == undefined ? "/pengelolaan-ajuan-pindah-kamar/isidataTableViewPindahKamar" : "/pengelolaan-ajuan-pindah-kamar/isidataTableViewPindahKamar?namaPerbaikan=" + encodeURIComponent(not.valP) ;
