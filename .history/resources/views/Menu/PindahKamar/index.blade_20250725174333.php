...
<script>
    function FillTheVoidPerbaiak(x){
        document.getElementById('idFillTheVoidPerbaiak').value = x
    }

    function RunTheButtonSearchPerbaiak(){
        document.getElementById('idButtonVoidPerbaiak').click();
    }

    function EnterRunningNowPerbaiak(event){
        if (event.key == 'Enter' || event.keyCode == 13){
            event.preventDefault();
            RunTheButtonSearchPerbaiak();
        }
    }
    </script>
<script>
    ...
    function tblViewDataPenghuni(not) {
        var url = not == undefined ? "/pengelolaan-ajuan-pindah-kamar/isidataTableViewPenghuni" : "/pengelolaan-ajuan-pindah-kamar/isidataTableViewPenghuni?namaPenghuni=" + encodeURIComponent(not.valP) ;
