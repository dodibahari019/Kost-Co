...
<script>
    var dataTableData = [
        {
            idTable : "#DataPengajuanCheckoutTableId",
            tblColumns : [0, 1, 2,3 ],
            dom: 'Bfrtip',
...
<script>
    ...
    function tblViewDataKamar(not) {
        ...
        var table = $("#DataPengajuanCheckoutTableId").DataTable({
            "responsive": false,
            "lengthChange": false,
            "autoWidth": true,
            "searching": false,
            ...
            "initComplete": function(settings, json) {
                table.buttons().container().appendTo('#DataPengajuanCheckoutTableId_wrapper .col-md-6:eq(0)');
            }
        });
    }
    </script>
