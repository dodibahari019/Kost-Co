...
@endsection
@section('Title', 'Pengajuan Check Out')
@section('tabView')
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane fade show active px-2" id="custom-tabs-one-pengajuanbpkb" role="tabpanel" aria-labelledby="custom-tabs-one-pengajuanbpkb-tab">
                                @include('Menu.PengajuanPindahKamar.Data.index')
                            </div>
...
<script>
    var dataTableData = [
        {
            idTable : "#DataPengajuanPindahKamarTableId",
            tblColumns : [0, 1, 2,3 ],
            dom: 'Bfrtip',
            btnNames : ['excelHtml5', 'pdfHtml5', 'print'],
            url : "/pengajuan-pindah-kamar/getViewPengajuanPindahKamar",
            method : "GET",
            noBtnPrint: true,
            bPaginate: true,
            responsive: true,
...
<script>
    $(document).ready(function(){
        var id = $('#cardContentDataPengajuanPindahKamar'),
            url = "/pengajuan-pindah-kamar/viewPengajuanPindahKamar";
...
<script>
    ...
    function tblViewDataKamar(not) {
        ...
        var table = $("#DataPengajuanPindahKamarTableId").DataTable({
            "responsive": false,
            "lengthChange": false,
            "autoWidth": true,
            "searching": false,
            ...
            "initComplete": function(settings, json) {
                table.buttons().container().appendTo('#DataPengajuanPindahKamarTableId_wrapper .col-md-6:eq(0)');
            }
        });
    }
    </script>
