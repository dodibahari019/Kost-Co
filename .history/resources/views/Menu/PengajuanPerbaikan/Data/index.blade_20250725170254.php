        ...
        <div class="col-5 vh-100" style="background-color: #FFFFFF; border: 3px solid #efefef; border-right: 0;">
            <form action="/pengajuan-pindah-kamar/store" class="classForm" id="CreateFormX" method="post">
                ...
                <div class="col-12 mt-3">
                    ...
                    <button hidden type="submit" id="IdOfHiddenButtonPerbaian" class="btn btn-outline-dark w-100">Simpan</button>
                </div>
            </form>
        </div>
    @endforeach
...
<script>
    ...
    function JalankanValidasiData() {
        ...
        if (!catatan) {
            ...
            document.getElementById('IdOfHiddenButtonPerbaian').click();
        }
    }
</script>