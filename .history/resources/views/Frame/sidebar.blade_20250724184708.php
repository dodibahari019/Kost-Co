<!-- Brand Logo -->
  ...
  headers: {
    ...
    error: function (xhr) {
        console.error(xhr.responseText); // Tambahkan log ini!
        Swal.fire({
            icon: 'error',
            title: 'Gagal Logout',
    ...
    <script>
        function ButtonClickLogOutCustomer(){
            document.getElementById('formLogoutCustomer').dispatchEvent(new Event('submit', { cancelable: true, bubbles: true }));
        }
    </script>