...
<body>
    ...
    <div class="col-md-6 d-flex flex-column justify-content-center align-items-center px-5">
        ...
        <form method="POST" action="/register-user" class="w-100" style="max-width: 400px;">
            ...
            <div class="mb-3">
                <input onkeydown="EnterButtonRegister(event)" type="text" name="name" class="form-control rounded" placeholder="Nama" required>
            </div>
            <div class="mb-3">
                <input onkeydown="EnterButtonRegister(event)" type="email" name="email" class="form-control rounded" placeholder="Email" required>
            </div>
            <div class="mb-3">
                <input onkeydown="EnterButtonRegister(event)" type="password" name="password" class="form-control rounded" placeholder="Kata Sandi" required>
            </div>
            <div class="mb-3">
                <input onkeydown="EnterButtonRegister(event)" type="text" name="phone" class="form-control rounded" placeholder="No. HP" required>
            </div>
            <div class="mb-3">
                <input onkeydown="EnterButtonRegister(event)" type="text" name="ktp" class="form-control rounded" placeholder="No. KTP" required>
            </div>
            <div class="mb-3">
                <input onkeydown="EnterButtonRegister(event)" type="text" name="address" class="form-control rounded" placeholder="Alamat" required>
            </div>
...
<script>
    function EnterButtonRegister(event){
