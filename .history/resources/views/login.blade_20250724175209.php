...
<body>
    ...
    <div class="col-md-6 d-flex flex-column justify-content-center align-items-center px-5">
        ...
        <!-- Form -->
        <form method="POST" action="/login-user" class="w-100" style="max-width: 400px;">
            @csrf
            <div class="mb-3">
        ...
        <form method="POST" action="/hash-password" class="w-100" style="max-width: 400px;">
            ...
            @method('put')
            <div class="mb-3">
                <input type="email" name="password" class="form-control rounded" placeholder="Email" required>
            </div>
            <div class="mb-3">
                <button type="submit" class="btn btn-outline-dark w-100">Masuk</button>
            </div>
